...
import com.android.dsly.rxhttp.utils.IOUtils;
...
public class CacheEntity<T> implements Serializable {
    ...
    private long localExpire;              // 缓存保存时的时间
     ...
     * @param currentTime  当前时间,小于当前时间视为过期
     * @return 是否过期
     */
    public boolean checkExpire(long cacheTime, long currentTime) {
        if (cacheTime == CACHE_NEVER_EXPIRE) return false;
        return getLocalExpire() + cacheTime < currentTime;
    }
